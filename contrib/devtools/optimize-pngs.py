...
basePath = subprocess.check_output([git, 'rev-parse', '--show-toplevel']).decode('utf8').strip()
totalSaveBytes = 0
noHashChange = True
...
for folder in folders:
    ...
    for file in os.listdir(absFolder):
        ...
        if extension.lower() == '.png':
            ...
            #verify
            if "Not a PNG file" in subprocess.check_output([pngcrush, "-n", "-v", file_path], stderr=subprocess.STDOUT).decode('utf8').strip():
